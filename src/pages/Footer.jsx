      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 ">
            <li className="hover:text-gray-500">Antivirus Shop</li>
            <li className="hover:text-gray-500">Privacy Policy</li>
            <li className="hover:text-gray-500">Refund and Returns Policy</li>
            <li className="hover:text-gray-500">Terms & Conditions</li>
